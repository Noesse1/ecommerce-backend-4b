...
INSERT INTO cliente (nome, email, telefone) VALUES ('Ana Beatriz', 'ana@email.com', '11999999999');
INSERT INTO cliente (nome, email, telefone) VALUES ('João Marcos', 'joao@email.com', '11988888888');
INSERT INTO cliente (nome, email, telefone) VALUES ('Mariana Silva', 'mariana@email.com', '11977777777');
INSERT INTO cliente (nome, email, telefone) VALUES ('Carlos Eduardo', 'carlos@email.com', '11966666666');
INSERT INTO cliente (nome, email, telefone) VALUES ('Lucas Lima', 'Lucas@email.com', '11955555555');

INSERT INTO pedido (data, status, valor_total, cliente_id) VALUES ('2026-09-01T10:00:00', 'AGUARDANDO', 4500.00, 1);
INSERT INTO pedido (data, status, valor_total, cliente_id) VALUES ('2026-09-01T11:30:00', 'PAGO', 2500.00, 2);
INSERT INTO pedido (data, status, valor_total, cliente_id) VALUES ('2026-09-02T09:15:00', 'ENVIADO', 3000.00, 3);
INSERT INTO pedido (data, status, valor_total, cliente_id) VALUES ('2026-09-02T14:20:00', 'ENTREGUE', 4000.00, 4);
INSERT INTO pedido (data, status, valor_total, cliente_id) VALUES ('2026-09-02T16:45:00', 'CANCELADO', 1200.00, 5);
